...
# animation constants
animation_start_delay = 3 # how many seconds the animation should stand still at the beginning
animation_time = 5 # how many seconds should the animation run
animation_end_delay = 1 # how many seconds the animation should stand still at the end
...
image_height = 64 # how many pixels should be displayed in a vertical line? The width is calculated from this
